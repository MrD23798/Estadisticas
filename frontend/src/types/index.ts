...
import { DependencyData, ComparisonData, EvolutionData } from '../services/apiService';

// Re-exportar tipos del servicio
export type { DependencyData, ComparisonData, EvolutionData } from '../services/apiService';

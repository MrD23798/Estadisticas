...
const EvolutionPanel: React.FC<EvolutionPanelProps> = ({
  ...
  const handleDependencyChange = (dependency: string) => {
    console.log('🔍 EvolutionPanel - Cambiando dependencia:', dependency);
    console.log('🔍 EvolutionPanel - Filtros actuales:', filters);
      ...
      <AnimatePresence>
        {showMenu && (
          ...
          >
            ...
            <motion.button 
              onClick={onGenerate}
              className={`w-full font-semibold py-3 px-4 transition-all ${
              ...
              style={filters.evolutionDependency && filters.evolutionStartMonth && filters.evolutionEndMonth && filters.evolutionYear ? { color: 'var(--text-primary)' } : {}}

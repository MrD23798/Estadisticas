...
import { ComparisonData } from '../../services/apiService';
...
const D3GroupedBarChart: React.FC<D3GroupedBarChartProps> = ({ 
  ...
  // Configuración del gráfico con dimensiones dinámicas
  const margin = useMemo(() => ({ top: 40, right: 40, bottom: 100, left: 60 }), []);
